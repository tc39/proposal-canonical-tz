...
export const ES = ObjectAssign({}, ES2022, {
  ...
  ParseTemporalTimeZone: (stringIdent) => {
    ...
    if (ianaName) {
      const identifier = ES.GetAvailableNamedTimeZoneIdentifier(ianaName);
  ...
  GetAvailableNamedTimeZoneIdentifier: (identifier) => {
    let canonical;
    try {
  ...
  IsAvailableNamedTimeZoneIdentifier: (identifier) => {
    return ES.GetAvailableNamedTimeZoneIdentifier(identifier) !== undefined;
  },
  ...
  TimeZoneEquals: (one, two) => {
    ...
    if (ES.IsAvailableNamedTimeZoneIdentifier(tz1)) tz1 = ES.GetCanonicalTimeZoneIdentifier(tz1);
    if (ES.IsAvailableNamedTimeZoneIdentifier(tz2)) tz2 = ES.GetCanonicalTimeZoneIdentifier(tz2);
    return tz1 === tz2;
  },
